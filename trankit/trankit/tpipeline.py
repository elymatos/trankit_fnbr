...
class TPipeline:
    ...
    def _set_up_config(self, training_config):
        ...
        self._config.lemma_type_only = training_config.get('lemma_type_only', False)
    ...
    def _prepare_posdep(self):
        ...
        self._config.itos[FNBR_TYPE] = {v: k for k, v in self.train_set.vocabs[FNBR_TYPE].items()}
    ...
    def _eval_posdep(self, data_set, batch_num, name, epoch):
        ...
        for batch in DataLoader(data_set, batch_size=self._config.batch_size,
            ...
            predicted_lemma_types = predictions[4]

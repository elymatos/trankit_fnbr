...
setup(
    ...
    install_requires=['adapters==1.1.1', 'transformers==4.48.3', 'numpy<2', 'protobuf', 'requests', 'torch>=1.6.0,<=2.0.1', 'tqdm>=4.27', 'langid==1.1.6', 'filelock', 'tokenizers>=0.21.0,<0.22', 'regex != 2019.12.17', 'packaging', 'sentencepiece', 'sacremoses', 'six'],
    entry_points={
    },
)
